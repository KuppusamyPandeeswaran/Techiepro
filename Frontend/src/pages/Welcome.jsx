  ...
  return (
    <div className="bg-[#f0faff]">
      <main className="w-full">
        <div className="flex items-center justify-center min-h-screen pt-12 max-sm:pt-12 ">
          <div className=" rounded-2xl p-6 w-full mt-24">
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-semibold text-center text-gray-800 mb-4">
            ...
            <div className="flex items-center mt-8 justify-center gap-6 max-sm:flex-col">
              <a
